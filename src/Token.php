...
class Token
{
    ...
    static public function getInstance($key = '!@#$)jwt(%^&*', $alg = 'HS256')
    {
    ...
    protected function __construct($key, $alg)
    {
        $this->key = $key;
        $this->alg = $alg;
    }
    ...
    public function encode($data, $exp = null, $nbf = null, $iat = null, $iss = null, $aud = null)
    {
        ...
        $this->config['iss'] = $iss ? $iss : 'https://www.haha.com';
        $this->config['aud'] = $aud ? $aud : 'https://www.haha.com';
